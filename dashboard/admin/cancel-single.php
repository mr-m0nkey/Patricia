                    ...
                    <div class="col-sm-8">
                        <div class="panel wallet-widgets p-0">
                            <div class="panel-body" style="min-height: 120px;">
                                <h4 class="text-right failed">Declined</h4>
                                <div class="row">
                                ...
                                <div class="prof-act">
                                    <button class="btn btn-success btn-exchange" type="button" data-toggle="modal" data-target="#success">Transfer Successful</button>
                                </div>
                            </div>
                        </div>
                    </div>
